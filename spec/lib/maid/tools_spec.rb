  ...
  describe Tools, :fakefs => true do
    ...
    describe '#git_piston' do
      ...
      it 'should pull and push the given git repository, logging the action' do
        Kernel.should_receive(:`).with("cd #@home/code/projectname && git pull && git push 2>&1")
        @logger.should_receive(:info)
        @maid.git_piston('~/code/projectname')
      end
    end
    ...
    describe '#sync' do
      ...
      it 'should sync the expanded paths, retaining backslash' do
        Kernel.should_receive(:`).with("rsync -a -u #@home/Downloads/ #@home/Reference 2>&1")
      ...
      it 'should have no options' do
        Kernel.should_receive(:`).with("rsync #@home/Downloads/ #@home/Reference 2>&1")
        @maid.sync(@src_dir, @dst_dir, :archive => false, :update => false)
      end

      it 'should add all options' do
        Kernel.should_receive(:`).with("rsync -a -v -u -m --exclude=.git --delete #@home/Downloads/ #@home/Reference 2>&1")
      ...
      it 'should add noop option' do
        ...
        Kernel.should_receive(:`).with("rsync -a -u -n #@home/Downloads/ #@home/Reference 2>&1")
        @maid.sync(@src_dir, @dst_dir)
      end
    end
  end
